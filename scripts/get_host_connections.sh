...
parser = argparse.ArgumentParser(description='Get count of host connections.')
...
message = {'id': 1, 'method': 'admin.get_host_connections', 'params': [args.password]}
...
for line in data.split("\n"):
    ...
    if message['id'] == 1:
        try:
            print int(message['result'])
        except:
            print "0"
    elif message['id'] == None:
