...
parser.add_argument('--host', dest='host', type=str, default=config.HOSTNAME, help='hostname of Stratum mining instance')
parser.add_argument('--port', dest='port', type=int, default=config.LISTEN_SOCKET_TRANSPORT, help='port of Stratum mining instance')
parser.add_argument('--prevhash', dest='prevhash', type=str, help='Prevhash of new block')
...
message = {'id': 1, 'method': 'mining.update_block', 'params': [args.password, args.prevhash]}
